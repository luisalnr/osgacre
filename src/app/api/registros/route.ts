      ...
      await db
        ...
        .onConflictDoUpdate({
          ...
          set: {
            ...
            unidadeCodigo: sqlExcluded("unidade_codigo"),
            unidadeNome: sqlExcluded("unidade_nome"),
            ...
            tema: sqlExcluded("tema"),
            ciclo: sqlExcluded("ciclo"),
            ponderador: sqlExcluded("ponderador"),
            planejadoDotacao: sqlExcluded("planejado_dotacao"),
            planejadoOrigem: sqlExcluded("planejado_origem"),
            planejadoEntrega: sqlExcluded("planejado_entrega"),
            liqDotacao: sqlExcluded("liq_dotacao"),
            funcaoProgramatica: sqlExcluded("funcao_programatica"),
            entregaDescricao: sqlExcluded("entrega_descricao"),
            quantidade: sqlExcluded("quantidade"),
            municipio: sqlExcluded("municipio"),
            publicoBeneficiado: sqlExcluded("publico_beneficiado"),
          },
        });
    }
